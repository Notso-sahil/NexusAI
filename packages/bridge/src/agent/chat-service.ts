...
import type { AttachmentMetadata } from '@nexusai/shared';
 ...
 *
 * Architecture Note: This service manages session-level orchestration without coupling to CLI/SDK implementation details.
 * It uses the Engine interface for dependency inversion, allowing engines to be swapped or added without altering HTTP routes.
 */
