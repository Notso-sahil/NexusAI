...
export interface AgentToolBridgeOptions {
   ...
   * If omitted, DEFAULT_SERVER_PORT from @nexusai/shared is used.
   */
  mcpUrl?: string;
}
 ...
 *
 * Architecture Note: Translates CLI tool calls into standardized MCP CallTool requests,
 * reusing the existing /mcp HTTP server infrastructure without proprietary protocols.
 */
