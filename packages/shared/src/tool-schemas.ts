...
export const NEXUS_FORM_AUTOFILL: ToolSchema = {
  name: 'nexus_form_autofill',
  description: 'Intelligently fill an entire HTML form using semantic label matching. Provide a key-value map of field labels to values and the tool automatically finds and fills each field.',
  inputSchema: {
    type: 'object',
    required: ['fields'],
    properties: {
