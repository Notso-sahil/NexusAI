<template>
  ...
  >
    <!-- Trigger Button (Draggable Handle) -->
    <button
      ref="triggerRef"
      ...
      title="Switch Views (Drag to reposition, double click to reset)"
    >
      <svg
      ...
      <div v-if="isOpen" class="navigator-overlay" @click="closeMenu">
        <div class="navigator-menu" :style="menuStyle" @click.stop>
          <div class="navigator-header">
            <span class="navigator-title">Navigation</span>
          ...
          <div class="navigator-items">
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">Agent Console</span>
                <span class="navigator-item-desc">Interactive execution & chat</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">Workflow Engine</span>
                <span class="navigator-item-desc">Replay and automated runs</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">Element Marker Registry</span>
                <span class="navigator-item-desc">Annotated DOM targets</span>
              </div>
