...
import type { AgentStoredMessage, AgentMessage, CodexReasoningEffort } from '@nexusai/shared';
...
import type { OpenProjectTarget } from '@nexusai/shared';
...
const currentManagementInfo = ref<import('@nexusai/shared').AgentManagementInfo | null>(null);
