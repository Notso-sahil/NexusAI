<template>
  <div class="section">
    <h2 class="section-title">Element Marker Registry</h2>
    <div class="config-card">
      <div class="status-section" style="gap: 8px">
        ...
        <div class="status-header">
          <p class="status-label">Registered Markers</p>
      ...
      <form class="mcp-config-section" @submit.prevent="onAdd">
        ...
        <div style="display: flex; gap: 8px; margin-bottom: 8px">
          <input v-model="form.name" placeholder="Marker name, e.g. Login Button" class="port-input" />
