<template>
  <div>
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        <label class="form-label">Attribute Value (check remove to delete)</label>
        <input class="form-input" v-model="(node as any).config.value" placeholder="Attribute value" />
      </div>
