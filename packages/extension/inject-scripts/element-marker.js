...
(function () {
    ...
    const PANEL_TEMPLATE = `
      <div class="em-panel" id="em_panel_root">
        ...
        <div class="em-controls">
          ...
          <button class="em-square-btn" id="__em_toggle_list" title="List Mode - Batch annotate similar elements (CSS only)">
            <svg viewBox="0 0 24 24">
  ...
  // Continuation of Selector Engine
  // ============================================================================
    ...
    try {
      ...
      if (res?.tool?.ok) {
        StateStore.set({
          validation: {
            status: 'success',
            message: `✓ Validation successful (${filteredMatches.length} matching elements)`,
          },
